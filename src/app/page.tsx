...
export default function Dashboard() {
  ...
  // Fullscreen Shift Lock Screen Portal when no active user is logged in
  if (currentUser === null) {
    return (
      <main style={{
        minHeight: "100vh",
        ...
        alignItems: "center",
        justifyContent: "center",
        background: "radial-gradient(circle at center, #121026 0%, #070610 100%)",
        fontFamily: "var(--font-family)",
        color: "#fff",
        padding: "20px",
        overflowY: "auto",
        ...
        <div className="glass-card" style={{
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <h1 style={{ fontSize: "1.5rem", fontWeight: "700", letterSpacing: "-0.5px" }}>AetherHMS Terminal Locked</h1>
            <p style={{ color: "var(--text-secondary)", fontSize: "0.85rem", marginTop: "6px" }}>
              Please authenticate your active shift operator profile to unlock the Property Management console.
            </p>
          </div>

          {authenticatingUser ? (
            /* PIN / Password entry pad for selected user */
            <form onSubmit={handleVerifyPassword} style={{ display: "flex", flexDirection: "column", gap: "20px", alignItems: "center", width: "100%" }}>
              {authSuccess ? (
                <div style={{ textAlign: "center", padding: "20px 0", display: "flex", flexDirection: "column", gap: "16px", alignItems: "center" }}>
                  <div style={{
                    ...
                    border: "2px solid var(--status-checkedin)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: "1.5rem",
                  ...
                  <div>
                    <h3 style={{ color: "#fff", fontSize: "1rem", fontWeight: "600" }}>Access Granted</h3>
                    <p style={{ color: "var(--text-secondary)", fontSize: "0.8rem", marginTop: "2px" }}>Initializing console...</p>
                  </div>
                </div>
              ) : (
                <>
                  <div style={{ textAlign: "center", width: "100%" }}>
                    <div className={styles.avatar} style={{ width: "48px", height: "48px", fontSize: "1.1rem", background: "var(--border-focus)", color: "#fff", margin: "0 auto 10px auto" }}>
                      {authenticatingUser.avatar}
                    </div>
                    <h3 style={{ fontSize: "1rem", color: "#fff", fontWeight: "600" }}>{authenticatingUser.name}</h3>
                    <span style={{ fontSize: "0.75rem", color: "var(--text-secondary)", display: "block", marginTop: "2px" }}>
                      Clearance: <strong>{authenticatingUser.role}</strong>
                    </span>
                  </div>

                  <div style={{ width: "100%" }}>
                    <label style={labelStyle}>Enter PIN / Password</label>
                    <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
                      <input
                        id="auth-pin-input"
                  ...
                  <div style={{ display: "flex", gap: "10px", width: "100%" }}>
                    <button className="btn-secondary" type="button" style={{ flex: 1, padding: "10px" }} onClick={() => {
                      setAuthenticatingUser(null);
                      setAuthPassword("");
                      setAuthError(null);
                    }}>
                    ...
                    <button className="btn-primary" type="submit" style={{ flex: 1.5, padding: "10px" }}>
                      🔑 Unlock Shift
                    </button>
                  </div>
                </>
            ...
            <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "10px" }}>
              <span style={{ fontSize: "0.8rem", color: "var(--text-secondary)", fontWeight: "600" }}>Select Operator Profile</span>
              <div style={{ display: "flex", flexDirection: "column", gap: "8px", maxHeight: "250px", overflowY: "auto", paddingRight: "4px" }}>
                {usersList.map((user) => (
                  ...
                  >
                    ...
                    <span style={{ fontSize: "0.8rem", color: "var(--border-focus)" }}>🔑 Login</span>
                  </div>
                ))}
              </div>
            </div>
